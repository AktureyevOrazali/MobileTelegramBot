...
class _BottomBarDividerState extends State<BottomBarDivider> {
  ...
  Widget buildItem(
    ...
    final EdgeInsets padDefault = EdgeInsets.only(
      top: widget.top!,
      bottom: widget.bottom! > 2 ? widget.bottom! + bottomSafe : bottomSafe,
    );

    isShadow = widget.enableShadow!;

    final Color itemColor = isSelected ? widget.colorSelected : color;
